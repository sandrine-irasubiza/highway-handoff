...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col lg:flex-row bg-[#F8FAFC] text-on-background selection:bg-primary/10">
      {/* Visual Side (Left) */}
      <div className="hidden lg:flex lg:w-1/2 relative min-h-screen overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between p-16 w-full">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-black text-white tracking-tighter uppercase">Highway Hand-Off</span>
          </div>
          <div className="max-w-xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-white/90 text-xs font-bold uppercase tracking-widest mb-6 backdrop-blur-md">
            ...
            <h1 className="text-[40px] leading-[1.1] font-extrabold text-white mb-6 drop-shadow-sm">
            ...
            <div className="flex gap-12">
              ...
              <div>
                ...
                <p className="text-white/60 text-sm">Real-time Tracking</p>
              </div>
            </div>
          </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-24 bg-[#F8FAFC]">
        <div className="w-full max-w-[480px]">
          {/* Mobile Header */}
          <div className="lg:hidden mb-12 flex flex-col items-center">
            <div className="w-12 h-12 bg-primary rounded-xl flex items-center justify-center shadow-xl mb-4">
              <MdLocalShipping className="text-white text-3xl" />
            </div>
            <span className="text-2xl font-black text-primary tracking-tighter uppercase">Highway Hand-Off</span>
          </div>

          {/* Form Container */}
          <div className="bg-white rounded-2xl p-8 lg:p-10 shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-slate-100">
            <div className="mb-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <MdMail className="text-slate-400 group-focus-within:text-primary transition-colors text-[20px]" />
                  </div>
                  <input
                    className="w-full h-14 bg-white border border-slate-200 rounded-lg pl-12 pr-4 outline-none focus:ring-2 focus:ring-primary/5 focus:border-primary transition-all placeholder:text-slate-400"
                    id="email"
                    name="email"
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <MdLock className="text-slate-400 group-focus-within:text-primary transition-colors text-[20px]" />
                  </div>
                  <input
                    className="w-full h-14 bg-white border border-slate-200 rounded-lg pl-12 pr-12 outline-none focus:ring-2 focus:ring-primary/5 focus:border-primary transition-all placeholder:text-slate-400"
                    id="password"
                    name="password"
                    placeholder="••••••••"
              ...
              <button
                type="submit"
                className="w-full h-14 bg-primary text-white font-bold text-lg rounded-lg shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30 hover:-translate-y-0.5 active:translate-y-0 transition-all flex items-center justify-center gap-2 group"
              >
                <span>Sign In</span>
